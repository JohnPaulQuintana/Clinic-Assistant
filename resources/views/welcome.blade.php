...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <header
        class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-neutral-800 dark:border-neutral-700">
        <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
            aria-label="Global">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl text-slate-700 font-semibold dark:text-white" href="#" aria-label="Brand">Eastwoods Clinic
                    Assistant</a>
                <div class="sm:hidden">
                    <button type="button"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end sm:ps-7">
                    <a id="medicineShow" class="py-3 ps-px sm:px-3 font-medium text-blue-600 dark:text-blue-500" href="#"
                        aria-current="page">Medicine</a>
                    {{-- <a class="py-3 ps-px sm:px-3 font-medium text-blue-600 dark:text-blue-500" href="#"
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            Dropdown
                            <svg class="ms-2 size-2.5 text-gray-500 dark:text-neutral-500" width="16" height="16"
