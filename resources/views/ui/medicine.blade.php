<div class="text-center hidden">
    <button id="medicineOverlayButton" type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#hs-medicine">
      Open modal
    </button>
  </div>
  
  <div id="hs-medicine" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all md:max-w-2xl md:w-full m-3 md:mx-auto">
      <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-800">
        <div class="absolute top-2 end-2">
          <button type="button" class="closeModal flex justify-center items-center size-7 text-sm font-semibold rounded-lg border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-transparent dark:hover:bg-neutral-700" data-hs-overlay="#hs-medicine">
        ...
        <div class="p-4 sm:p-10 overflow-y-auto">
          <div class="mb-6 text-center">
            ...
            <p class="text-gray-500 dark:text-neutral-500">
              This is the list's of available medicine.
            </p>
          </div>
  
          <div class="grid grid-cols-1 md:grid-cols-2 gap-2 items-center justify-center" id="available-results">
